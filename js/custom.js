...
window.onload = function () {
    ...
    document.getElementById('buttonStop').addEventListener(
        'click', function () {
            timer.Stop();
        });
    ...
    document.getElementById('buttonPomodore').addEventListener(
        'click', function () {
            resetMainTimer(25*60);
            timer.Start();
        });

    document.getElementById('buttonShortBreak').addEventListener(
        'click', function () {
            resetMainTimer(5*60);
            timer.Start();
        });

    document.getElementById('buttonLongBreak').addEventListener(
        'click', function () {
